/**
 * SISTEMA COMBINADO: LOGO CAROUSEL + CONVENIOS P&P - UNAL SEDE DE LA PAZ
 * Proyecto Apps Script unificado para logos de instituciones y convenios
 *
 * INSTRUCCIONES:
 * 1. Crea un nuevo proyecto en Google Apps Script (script.google.com)
 * 2. Copia este archivo como Code.gs
 * 3. Copia el HTML correspondiente como archivo HTML en el mismo proyecto
...
/**
 * Entry point para la aplicación web combinada
 * @return {HtmlOutput} Página HTML del logo carousel + convenios
 */
function doGet() {
  const htmlOutput = HtmlService.createTemplateFromFile('convenios')
      .evaluate()
      .setTitle('Instituciones y Convenios - UNAL Sede de La Paz')
...
/**
 * Obtiene la configuración de URLs de imágenes del carousel
 * @return {Object} Configuración de paths de imágenes
 */
function getImageConfig() {
  return {
    basePath: 'https://lh3.googleusercontent.com/d/',
    logos: getLogosWithIds()
  };
}

/**
 * Mapeo de logos a IDs de Google Drive
 * @return {Object} Mapeo de archivos de logos
 */
function getLogosWithIds() {
  return {
    'ANEI.webp': '1QvqeCcysp7_FaroRI8YLBxDCIxemlJXF',
    'Alcaldía de La Paz.png': '11WH6VcGbQNT0kShievyOH7EDdkLg059Z',
    'ASOHOFRUCOL.png': '1dPpk8_EmOGYnIxt8-8BdmlX_wracWDBD',
    'Alianza Francesa.png': '1sjvyh4aglQpbcVuqJMSwIBth0p1tMo9I',
    'comfacesar.png': '1_WgXaU87rtvKVmru8Ir15Q-Au4WbiDwV',
    'Alcaldía de San Diego.png': '1AHrrQuNwQshdzNuxtcONBAnskPOGrThw',
    'Cámara de comercio de Valledupar.png': '1wLQ0omihDPVuGucRFFj3-K91uk20sdmg',
    'La rotativa.png': '1WDuLt6BaIAx3ld69MnYnjg4pwdOqBY-8',
    'Laboratorio Nancy Florez.png': '1ZrodE4XelRUpPoziQri0quM8VE0hfYUH',
    'LOGO-AGROSOLIDARIA-.png': '1WyA4z85ytm87SUU_3NQfwcH7QIYQUGLi',
    'logo-palmas.png': '1KZj91lpS0JHQa27c73CGyI6Krh7ra40g',
    'Logo-PDPC-.webp': '1cWe-wtkm_fMV5lUW8Pe4_oQCcwh0URjp',
    'LOGO-PRODERI-CON-SLOGAN-BLANCO-1-2048x621.png': '1lHosdjzqS-m5d6dWGeTGPdwA7nDr_iOj',
    'logo-dark.svg': '1-wccxb1y9k664HSoIoCMgUhRS2TRKb8G',
    'Logos Reserva Natural Los Tananeos.avif': '1DM41GdPC9L2QCgowoVPR8dteXK5dkgmN'
  };
}
...
function setupConfiguration() {
  console.log('=== CONFIGURANDO SCRIPT PROPERTIES (Logo Carousel + Convenios) ===');
...
function verifyConfiguration() {
  console.log('=== VERIFICANDO CONFIGURACIÓN (Logo Carousel + Convenios) ===');
